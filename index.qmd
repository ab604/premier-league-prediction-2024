...
I repeated this using the six year win and draw averages for Manchester City and Liverpool which yields @fig-pred-wins-mean and @fig-pred-draws-mean respectively. And @tbl-2024-mean.
